<template>
  <div class="space-y-6">
      ...
      >
        <div class="flex flex-wrap items-center gap-3 flex-1">
          ...
          <FilterDropdown
            ...
            @apply="fetchBrands"
          >
            <FilterSection label="Brand Status" last>
              <ContextDropdown
    ...
    >
      ...
      >
        <TagIcon class="h-10 w-10 text-gray-300" />
      </div>
      <h3 class="text-xl font-bold text-gray-700 mb-2">No Brands Found</h3>
      <p class="text-gray-500 max-w-sm mx-auto text-sm leading-relaxed mb-8">
        We couldn't find any brands. Start by creating a new one or adjust your
        search filters.
      </p>
      <button
        v-if="canAdd"
